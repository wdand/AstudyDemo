...
public class CltView extends View {
    ...
    private float radiusWidthRatio = 2f / 6;//裁剪圆框的半径占view的宽度的比
    ...
    public CltView(Context context) {
        this(context, null);
    }

    public CltView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CltView(Context context, AttributeSet attrs, int defStyle) {
