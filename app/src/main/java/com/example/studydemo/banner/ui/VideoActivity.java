...
import com.example.studydemo.banner.indicator.NumIndicator;
import com.example.studydemo.banner.viewholder.VideoHolder;
...
public class VideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        banner.addBannerLifecycleObserver(this)
                .setAdapter(new MultipleTypesAdapter(this, BannerDataBean.getTestDataVideo()))
