package com.bingkong.bkbase.ui.widget.pullrefresh;
...
public class XListView extends ListView implements OnScrollListener {
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        ...
        if (scrollState == OnScrollListener.SCROLL_STATE_IDLE) {
            if (mHasMoreData && mEnableAutoLoad && getLastVisiblePosition() + 10 > getCount()) {
                startLoadMore();
            }
        }
    }
    ...
    static class SavedState extends BaseSavedState {
        ...
        public SavedState(Parcel in) {
            ...
            this.refreshEnable = b[1];
            this.loadMoreEnable = b[2];
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeBooleanArray(new boolean[]{isHaveMoreData, refreshEnable, loadMoreEnable});
