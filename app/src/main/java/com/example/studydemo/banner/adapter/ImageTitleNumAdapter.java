 ...
 * 自定义布局，图片+标题+数字指示器
 */
public class ImageTitleNumAdapter extends BannerAdapter<BannerDataBean, ImageTitleNumAdapter.BannerViewHolder> {

    public ImageTitleNumAdapter(List<BannerDataBean> mDatas) {
