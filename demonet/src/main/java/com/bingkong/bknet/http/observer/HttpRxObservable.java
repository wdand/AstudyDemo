...
import com.bingkong.bknet.http.function.HttpResultFunction;
import com.bingkong.bknet.http.function.ServerResultFunction;
...
public class HttpRxObservable {
     ...
     * @author niejiahuan
     */
    public static Observable getObservable(Observable<Response<HttpResponse>> apiObservable) {
       // showLog(request);
     ...
     * @author niejiahuan
     */
    public static Observable getObservable(Observable<Response<HttpResponse>> apiObservable, LifecycleProvider lifecycle) {
        //showLog(request);
     ...
     * @author niejiahuan
     */
    public static Observable getObservable(Observable<Response<HttpResponse>> apiObservable, LifecycleProvider<ActivityEvent> lifecycle, ActivityEvent event) {
       // showLog(request);
        Observable observable;
        if (lifecycle != null) {
     ...
     * @author niejiahuan
     */
    public static Observable getObservable(Observable<Response<HttpResponse>> apiObservable, LifecycleProvider<FragmentEvent> lifecycle, FragmentEvent event) {
      //  showLog(request);
        Observable observable;
        if (lifecycle != null) {
