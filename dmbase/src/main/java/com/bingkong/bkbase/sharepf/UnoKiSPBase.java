...
public class UnoKiSPBase {

    protected String spName;

    public UnoKiSPBase(String spName) {
        this.spName = spName;
    }
...
//        if (com.iqiyi.paopao.base.utils.PPLogUtils.logisDebug() && !TextUtils.isEmpty(value) && value.length() > 256) {
...
//            if (com.iqiyi.paopao.base.utils.PPLogUtils.logisDebug() && !TextUtils.isEmpty(str) && str.length() > 256) {
