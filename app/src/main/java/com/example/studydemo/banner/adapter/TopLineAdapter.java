 ...
 */
public class TopLineAdapter extends BannerAdapter<BannerDataBean, TopLineAdapter.TopLineHolder> {

    public TopLineAdapter(List<BannerDataBean> mDatas) {
        super(mDatas);
    }
    ...
    @Override
    public void onBindView(TopLineHolder holder, BannerDataBean data, int position, int size) {
